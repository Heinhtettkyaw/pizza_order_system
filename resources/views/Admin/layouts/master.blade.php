                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            ...
                                            <a href="#">
                                                <img src="{{asset('image/default_profile.png')}}" alt="John Doe" />
                                            </a>
                                            @else
                                            <a href="#">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__footer">
                                                ...
                                                <form action="{{route('logout')}}" method="POST" class="d-flex justify-content-center mb-4">
                                                @csrf
                                                    <button class="btn bg-danger text-white col-10" type="submit"><i class="zmdi zmdi-power"></i>Logout</a></button>
                                            </form>
                                            </div>
                                        </div>
                                    </div>
